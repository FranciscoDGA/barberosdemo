...
export const ReviewsView: React.FC = () => {
  ...
  const handleSendReview = (e: React.FormEvent) => {
    ...
    submitReview({
      ...
      barberName: barberObj?.name || `Barbeiro ${SALON.nome}`,
      rating: newRating,
    ...
    alert(`Obrigado pela sua avaliação! Ela já está visível para toda a comunidade ${SALON.nome}.`);
  };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-slate-400">
            Veja o que os clientes dizem sobre a experiência na {SALON.nome}.
          </p>
        </div>
        ...
        <div className="flex items-center gap-4 text-center sm:text-left">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-2 text-[11px] text-emerald-400 font-semibold">
              ...
              <span>98% dos clientes recomendam a {SALON.nome}</span>
            </div>
          </div>
        </div>
