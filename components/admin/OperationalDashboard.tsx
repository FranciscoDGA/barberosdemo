...
export default function OperationalDashboard({ selectedDate }: OperationalDashboardProps) {
  ...
  const statusColor = (status: AppointmentStatus) => {
    switch (status) {
      ...
      case 'aguardando': return 'bg-emerald-500/20 text-emerald-400 border-emerald-500/30';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
        ...
        <div className="bg-slate-900/70 p-3 rounded-2xl border border-emerald-500/30 text-center">
          <p className="text-2xl font-black text-emerald-400">{stats.aguardando + stats.confirmed}</p>
      ...
      <div className="bg-slate-900/60 rounded-2xl border border-slate-800 overflow-hidden">
        <div className="p-4 border-b border-slate-800 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-[10px]">
            ...
            <span className="flex items-center gap-1"><span className="w-2 h-2 rounded bg-emerald-500" /> Almoço</span>
          </div>
        </div>
