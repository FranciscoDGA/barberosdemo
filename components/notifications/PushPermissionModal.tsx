...
export const PushPermissionModal: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const hasPrompted = localStorage.getItem('barberos_push_prompted');
  ...
  const handleDismiss = () => {
    localStorage.setItem('barberos_push_prompted', 'dismissed');
    setShowPrompt(false);
  };
  ...
  const handleEnablePush = async () => {
    try {
      ...
      localStorage.setItem('barberos_push_prompted', permission);
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-slate-300 mt-1 leading-relaxed">
            Receba notificações automáticas da {SALON.nome} lembrando o horário do seu corte.
          </p>
