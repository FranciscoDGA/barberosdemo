...
export function gerarMensagemLembrete24h(appointment: Appointment): string {
  ...
  return SALON.lembretes.tmplLembrete(appointment.time, servico, barbeiro);
}
...
export function gerarMensagemLembrete2h(appointment: Appointment): string {
  ...
  return SALON.lembretes.tmplConfirmacao(appointment.time, servico, barbeiro);
}
...
export function gerarMensagemLembrete30min(appointment: Appointment): string {
  ...
  return SALON.lembretes.tmplUrgente(appointment.time, servico, barbeiro);
}

export function gerarMensagemPosAtendimento(appointment: Appointment): string {
  return SALON.lembretes.tmplPosAtendimento(appointment.customerName);
}

export function gerarMensagemAvaliacao(appointment: Appointment): string {
  return SALON.lembretes.tmplAvaliacao(appointment.customerName);
}
