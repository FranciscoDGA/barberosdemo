...
export async function GET() {
  return NextResponse.json({
    status: 'online',
    service: `${SALON.nome} WhatsApp Webhook (Uazapi)`,
  ...
  try {
    ...
    if (!replyText) {
      ...
      try {
        ...
        replyText =
          `Olá! Sou o ${SALON.assistente.nome} da Barbearia ${SALON.nome}. Você pode tirar dúvidas sobre serviços ou agendar diretamente pelo link: ${SALON.url}/agendar`;
      }
    }
