...
export default function MarketingPage() {
  ...
  const mirrorBookingUrl = useMemo(() => {
    const origin = typeof window !== 'undefined' ? window.location.origin : SALON.url;
            ...
            <div className="mt-4 flex items-center gap-2">
              <a
                href={`https://wa.me/?text=${encodeURIComponent(
                   `Fala barbeiro! Aqui está o seu link exclusivo do QR Code de cadeira da ${SALON.nome}: ${mirrorBookingUrl}\n\nColoque no espelho da sua bancada para seus clientes agendarem com você direto na cadeira!`
                )}`}
                target="_blank"
                rel="noopener noreferrer"
